    ...
    <div className="select-none relative bg-purple-90 w-screen h-screen ">
      ...
      <div className="absolute w-screen h-screen flex lg:flex-row flex-col justify-center">
        <div className="relative  w-full flex items-center justify-center">
          <div className="absolute z-50 max-w-[700px] h-[480px] rounded-lg bg-white "></div>
          <div className="absolute z-50 max-w-[700px] h-[480px] p-6 bg-white flex flex-col">
            <ResetPasswordHeader />

            <div className="grid place-items-center">
              <p className="text-[#666666] font-bold">
                Go to e-mail and verify
              </p>
              <img
