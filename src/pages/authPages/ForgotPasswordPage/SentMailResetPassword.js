        ...
        <div className="select-none relative bg-purple-90 w-screen h-screen ">
            ...
            <div className="absolute w-screen h-screen flex lg:flex-row flex-col justify-center">
                ...
                <div className="relative lg:w-1/2 w-full flex items-center justify-center">
                    <div className="absolute z-50 xl:w-11/12 w-11/12 h-[480px] rounded-lg bg-white opacity-50">

                    </div>
                    <div className="absolute z-50 xl:w-11/12 w-11/12 h-[480px] p-6  flex flex-col">
                        <ResetPasswordHeader />


                        <div className="grid place-items-center">
                            <p className="text-[#666666] font-bold">Go to e-mail and verify</p>
                            <img
                                src={process.env.PUBLIC_URL + "check_circle.svg"}
                                className="w-[50px] pt-[32px]"
                            />
                        </div>
